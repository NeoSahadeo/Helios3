...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let passwords = [];
  return `<header data-svelte-h="svelte-1ind219"><div class="logo ml-2"><h1>Helios 3</h1> <span>Created Neo Sahadeo</span></div></header> <main class="mt-8">${each(passwords, (password) => {
